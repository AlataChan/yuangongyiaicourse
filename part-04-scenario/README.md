...
每个智能体只负责一种主要判断。资料员不替写作员发挥，写作员不擅自补充缺失数据，审核员发现问题后也不直接重写全文，而是指出问题并退回对应环节。

这种模式适合报告撰写、案例整理、传播内容制作等具有稳定流程的任务。使用时要为每一步规定清楚：
...
流水线的优势是过程稳定、责任清楚、便于检查；不足是灵活性较低。如果前面一步出现错误，问题可能沿着流程传递，因此每次交接都需要传递经过整理的任务包，而不是只依赖聊天记录。
...
公众号或社交媒体内容 → 传播智能体
资料不足或意图不清 → 先向用户追问
涉及隐私、资金或公开承诺 → 转入审核与人工确认
```

主控智能体的核心职责是判断任务归属、拆分任务和控制边界，而不是亲自完成所有工作。它需要先识别用户的目标、已有材料、期望成果和风险等级，再决定由谁处理。

如果一个任务包含多个彼此独立的部分，主控还可以同时分派给多个专责智能体。例如，「调研三个同类项目并提出借鉴建议」，可以由三个调研智能体分别查找资料，再由汇总智能体比较异同、形成结论。这样可以缩短处理时间，也能避免一个智能体在大量资料之间来回切换。

如果某个子任务本身需要大量检索、分析或工具操作，主控也可以把它作为一个独立任务交出去。专责智能体完成后，需要把结论、依据、缺失信息和风险提示一起交回，由主控统一整合。

这种模式适合同时处理文书、案例、传播和综合问答的项目助理。使用时要特别注意：
...
审核智能体不应只给出「写得不好」「语气需要调整」这类笼统评价，而应明确指出：
...
同伴互审的价值不是让两个智能体反复重写全文，而是尽早发现问题并进行局部返工。为了避免无休止循环，可以预先规定审核清单、最多返工次数和最终升级条件。连续两轮仍无法解决的问题，应交给人工判断。

### 3.4 人机共审：高风险节点必须停下来

人机共审适合涉及隐私、资金申请、对外承诺、政策判断和公开发布等高风险任务。在这种模式中，AI 可以搜集材料、生成初稿、核对清单和提示风险，但不能代替人作出最终决定。
...
人机共审的核心原则是：**AI 可以提高准备和检查效率，但高风险决策权、对外行动权和最终责任必须由人掌握。**
